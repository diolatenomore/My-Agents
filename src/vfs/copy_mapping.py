...
class CopyMapping:
    ...
    @classmethod
    def register(cls, source_path: str, target_path: str):
        """注册复制记录"""
        # 更新缓存
    ...
    @classmethod
    def mark_copied(cls, source_path: str):
        """拷贝所有未被拷贝的文件并修改标记"""
        records = cls.get_from_db(task_id=cls.task_id, source_path=source_path)
        # 如果原文件有暂存区路径则使用
    ...
    @classmethod
    def mark_copied_dir(cls, source_path: str):
